...
install:
    ...
    sudo mkdir ~/.config/omxplaylist || echo (echo "\033[0;34m==> \033[0;31mERROR: \033[0mCould not create directory in ~/.config/; exit 1; ")
...
clean:
    ...
    sudo rm -rf ~/.config/omxplaylist || (echo "echo "\033[0;34m==> \033[0;31mERROR: \033[0momxplayer directory could not be found and could not be removed."; exit 1; )
